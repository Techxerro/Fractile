...
const Header = () =>{
    ...
    useEffect(()=>{
        ...
        ServicesList.map((obj)=>{       
                ...
                if(location.pathname.includes('modeling') || location.pathname.includes('visualisation') || location.pathname.includes('BIM') )  {
                ...
                else if(location.pathname.includes('shop-drawing-creation') || location.pathname.includes('2D-overlay') || location.pathname.includes('RFI-order-date-in-PM-software') ){
    ...
    return(
            ...
            <div className="container mainbar">
                <div className="row">
                    ...
                    <div className="col-6 d-flex align-items-center justify-content-center">
                        <div className="menu">
                            <ul>
                                <li className="page-link" style={{width:'120px',textAlign:'center'}}><a href="/">Home</a></li>
                                <li className="page-link submenuhover" id="service"  style={{width:'120px',textAlign:'center'}}>
                                    <span onClick={()=>setopensubMenu(!opensubMenu)}
                                    onMouseOver={(e)=>MouseIn(e)}
                                    onMouseOut={(e)=>MouseOut(e)}
                                    >What we do</span>                                    
                                    {/* <div className="submenuoverlay"></div> */}
                                    <div className="submenu" style={{top:opensubMenu ? '0':'-100%' }}>                                        
                                        <div className="row">
                                            <div className="col-4">
                                                <ul className="menu-items">                                                    
                                                    {ServicesList.map((SL)=>{
                                                        return(<li key={SL.id} onClick={(e)=>openSubServices(e)} style={{opacity:`${Service===SL.ServiceName ? '1' : '0.75'}`}} >{SL.ServiceName}</li>)
                                                    })}
                                                </ul>                                              
                                            </div>
                                            <div className="col-3">
                                                        ...
                                                        <ul key={SL.id}>
                                                            ...
                                                            SL.subService.map((SSL)=>{
                                                                return( 
                                                                    <>
                                                                        {SSL.hasservice ?
                                                                        <li key={SSL.id} onClick={(e)=>openSubSubServices(e)} className={Subservice===SSL.name ? 'active' : 'inactive'}>
                                                                          {SSL.name}
                                                                        </li> :
                                                                        <li key={SSL.id} className={location.pathname===SSL.link ? 'active' : 'inactive'} >
                                            ...
                                            <div className="col-4 contactinfo">
                                                <div className="closebtn1" onClick={()=>setopensubMenu(!opensubMenu)}>
                                                    <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M1.5 1.5L25 25" stroke="white" stroke-width="2"/>
                                                        <path d="M25 1.5L1.5 25" stroke="white" stroke-width="2"/>
                                                    </svg>
                                                </div>
                                                {ServicesList.map((SL)=>{
                                                    return(                                                      
                                                        ...
                                                        return(
                                                            <div key={obj.id}>
                                                                {obj.name == Subservice ?                                                                 
                                                                    <ul>                                                                              
                                                                        {
                                                                            obj.subsubservices.map((innerobj)=>{
                                                                                return(                                                                                    
                                                                                    <li className={location.pathname===innerobj.link  ? "currentpage" :""} style={{padding:'0 20px'}}><a href={innerobj.link}>{innerobj.name}</a></li> 
                                ...
                                <li className="page-link submenuhover" style={{width:'120px',textAlign:'center'}}>
                                    <span onClick={()=>setopensubAboutMenu(!opensubAboutMenu)}>Company</span>
                                    {/* <div className="teamsubmenuoverlay"></div> */}
                                    <div className="submenu teamsubmenu" 
                                    ...
                                    >                                         
                                        <div className="row">
                                            ...
                                            <div className="col-4 contactinfo">
                                            <div className="closebtn1" onClick={()=>setopensubAboutMenu(!opensubAboutMenu)}>
                                                    <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M1.5 1.5L25 25" stroke="white" stroke-width="2"/>
                                                        <path d="M25 1.5L1.5 25" stroke="white" stroke-width="2"/>
                                                    </svg>
                                                ...
                                                <h5>Contact</h5>
                                                <p>(571) 297-1409</p>
                                                <p>7900 Westpark<br/>DriveMcLean, VA 2012</p>
                ...
                <div className="row">
                    ...
                    <div className="col-6 d-flex align-items-center justify-content-end">
                        <button className="menubtn" onClick={()=>setopenMenu(!openMenu)}>
                            ...
                            <path d="M15.9505 28.5L0.838044 0.5H38.0495L53.162 28.5H15.9505Z" fill="#157438" stroke="white"/>
        ...
        <div className="mobilemenu" style={{left:openMenu ? '0%' : '-100%'}}>
            <ul>
                ...
                <li className="page-link"><a href="/team">Team</a></li>
                <li className="page-link d-flex align-items-center " onClick={()=>setisDropdownOpen(!isDropdownOpen)}>Services {isDropdownOpen ? <span className="arrow-down"></span> : <span className="arrow-up"></span> }</li>
                    {isDropdownOpen ? 
